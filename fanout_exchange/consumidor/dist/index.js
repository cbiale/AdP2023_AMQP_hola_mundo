...
function obtener() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // declaramos exchange
            yield canal.assertExchange(nombreExchange, 'fanout', { durable: true });
            // declaramos una cola ( Nombre de cola vacío para generar uno temporal)
            const queue = '';
            const controlCola = yield canal.assertQueue(queue, { exclusive: false });
            const nombreCola = controlCola.queue;
            yield canal.bindQueue(nombreCola, nombreExchange, '');
